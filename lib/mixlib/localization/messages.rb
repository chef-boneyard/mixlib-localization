...
module Mixlib
  module Localization
    class Messages
      ...
      # Retrieve the error message given the error key (e.g. 'opscode-chef-webui-nodes-403') and the language code (e.g. 'en-us')
      # returns the array of error code (customer support purpose) and the message. (e.g. ["a7svai98", "You are not authorized to view the node."])
      # returns nil if message key does not exist
      def self.find_message(message_key, language_code="en_us")
        message_hash = self.messages[message_key.to_s]
        if message_hash
          [message_hash["message_id"], message_hash["languages"][language_code.to_s] || message_hash["languages"]["en_us"]]
        else
      ...
      # Retrieve the error message given the message id (e.g. '123456') and the language code (e.g. 'en-us')
      # returns the array of error code (customer support purpose) and the message. (e.g. ["123456", "You are not authorized to view the node."])
      # raises an exception if the message id doesn't exist
      def self.get_message_by_id(message_id, language_code='en_us')
        message_hash = self.messages_by_id[message_id]
        if message_hash
          [message_hash["message_id"], message_hash["languages"][language_code.to_s] || message_hash["languages"]["en_us"]]
        else
          raise MessageRetrievalError, "Cannot find the error message with message_id '#{message_id}'."
        end
      end

      # Retrieve the error message given the message id (e.g. '123456') and the language code (e.g. 'en-us')
      # returns the array of error code (customer support purpose) and the message. (e.g. ["123456", "You are not authorized to view the node."])
      # returns nil if the message id doesn't exist
      def self.find_message_by_id(message_id, language_code='en_us')
        message_hash = self.messages_by_id[message_id]
        if message_hash
          [message_hash["message_id"], message_hash["languages"][language_code.to_s] || message_hash["languages"]["en_us"]]
        else
    ...
    "opscode-chef-webui-users-rescind_invite-confirm" => {
        ...
        "opscode-chef-webui-environments-index-403" => {
          "message_id" => "33000",
          "languages" => {
            "en_us" => "Permission denied. You do not have permission to list the environments in this organization.",
        ...
        "opscode-chef-webui-environments-destroy-confirm" => {
          "message_id" => "33003",
          "languages" => {
        ...
        "opscode-chef-webui-environments-acl-get-403" => {
          "message_id" => "33016",
          "languages" => {
            "en_us" => "Permission denied. You do not have permission to read the permissions on this environment.",
            "zh_cn" => "对不起，您没有权限读取此环境的权限设置。"
          }
        },
        ...
        "opscode-chef-webui-environments-container-acl-set" => {
          "message_id" => "33018",
          "languages" => {
            "en_us" => "Failed to set permissions on the environments collection in this organization.",
        ...
        "opscode-chef-webui-quick-start-terminate-403" => {
          "message_id" => "40000",
          "languages" => {
            "en_us" => "Permission Denied. You do not have permission to terminate this quick start instance.",
            "zh_cn" => "对不起，您没有权限结束此快速开始实例。"
          }
        },
        "opscode-chef-webui-quick-start-terminate-404" => {
          "message_id" => "40001",
          "languages" => {
            "en_us" => "Not Found. The quick start instance may have been terminated.",
            "zh_cn" => "无法找到此快速开始实例，它可能已经被结束。"
          }
        },
        "opscode-chef-webui-quick-start-terminate-500" => {
          "message_id" => "40002",
          "languages" => {
            "en_us" => "An application error has occurred. Please try again later.",
            "zh_cn" => "应用程序错误，请稍候重试。多谢理解。"
        ...
        "opscode-chef-webui-quick-start-status-terminating-instance" => {
          "message_id" => "40004",
          "languages" => {
            "en_us" => "Terminating Instance",
            "zh_cn" => "正在结束"
          }
        },
        "opscode-chef-webui-quick-start-status-termination-success" => {
          "message_id" => "40005",
          "languages" => {
            "en_us" => "Terminated",
            "zh_cn" => "已结束"
        ...
        "opscode-chef-webui-quick-start-status-termination-failure" => {
          "message_id" => "40006",
          "languages" => {
            "en_us" => "Failed Terminating Instance",
            "zh_cn" => "结束失败"
          }
        },
        "opscode-chef-webui-quick-start-status-termination-timeout" => {
          "message_id" => "40007",
          "languages" => {
        ...
        "opscode-chef-webui-quick-start-status-provisioning-instance" => {
          "message_id" => "40008",
          "languages" => {
            "en_us" => "Provisioning Instance",
            "zh_cn" => "建立中"
          }
        },
        "opscode-chef-webui-quick-start-status-provision-success" => {
          "message_id" => "40009",
          "languages" => {
            "en_us" => "Success",
            "zh_cn" => "成功"
        ...
        "opscode-chef-webui-quick-start-status-provision-failure" => {
          "message_id" => "40010",
          "languages" => {
            "en_us" => "Failed Provisioning Instance",
            "zh_cn" => "建立服务器失败"
          }
        },
        "opscode-chef-webui-quick-start-status-provision-timeout" => {
          "message_id" => "40011",
          "languages" => {
            "en_us" => "Timed Out Provisioning Instance",
            "zh_cn" => "建立服务器超时"
          }
        },
        "opscode-chef-webui-quick-start-status-populating-data" => {
          "message_id" => "40012",
          "languages" => {
            "en_us" => "Populating Organization Data",
            "zh_cn" => "准备建立服务器：处理数据中"
          }
        },
        "opscode-chef-webui-quick-start-status-data-population-success" => {
          "message_id" => "40013",
          "languages" => {
            "en_us" => "Organization Populated",
            "zh_cn" => "数据准备完毕"
          }
        },
        "opscode-chef-webui-quick-start-status-data-population-failure" => {
          "message_id" => "40014",
          "languages" => {
            "en_us" => "Failed Populating Organization Data",
            "zh_cn" => "数据准备失败"
          }
        },
        "opscode-chef-webui-quick-start-status-data-population-timeout" => {
          "message_id" => "40015",
          "languages" => {
      ...
      MESSAGES_BY_ID = MESSAGES_BY_KEY.inject({}) do |memo, (k, v)|
        memo[v["message_id"]] = v.merge({"message_key" => k})
        memo
      end.freeze
